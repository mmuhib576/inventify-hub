...
public class UpdateProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editProductName.setText(WearLanding.selectedProduct.productName);
        editProductPrice.setText(WearLanding.selectedProduct.productPrice);
        editProductDescription.setText(WearLanding.selectedProduct.productDescription);
        editProductQuantity.setText(WearLanding.selectedProduct.productQuanitty);
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        FirebaseDatabase.getInstance().getReference().child(WearLanding.did).child(WearLanding.selectedProduct.key).setValue(null).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
    ...
    void checkData(){
        ...
        if(pName.isEmpty()){
            ...
            ref.child(WearLanding.did).child(WearLanding.selectedProduct.key).setValue(object).addOnSuccessListener(new OnSuccessListener<Void>() {
                @Override
                public void onSuccess(Void unused) {
